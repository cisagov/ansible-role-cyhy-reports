...
| -------- | ----------- | ------- | -------- |
| cyhy\_reports\_cyhy\_core\_version | The version of cisagov/cyhy-core to use; must be a valid git reference. | `v1.3.4` | No |
...
| cyhy\_reports\_version | The version of cisagov/cyhy-reports to install; must be a valid git reference. | `v2.2.1` | No |
